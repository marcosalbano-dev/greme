  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?php echo route_to('home'); ?>">
        <img src="<?php echo base_url('assets/img/greme.jpg'); ?>" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Grupo Espírita Meimei</span>
      </a>
    </div>

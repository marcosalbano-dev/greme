<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-floating mb-3">
            <input type="text" class="form-control" placeholder="Nome" name="name" value="<?php echo old('name', $teacher->name); ?>" id="name">
    ...
    <div class="col-md-6">
        <div class="form-floating mb-3">
            <input type="cpf" class="form-control cpf" placeholder="CPF" name="cpf" value="<?php echo old('cpf', $teacher->cpf); ?>" id="cpf">
...
<div class="row mt-4">
    ...
    <div class="col-md-2">
        <div class="form-floating mb-3">
            <input type="text" class="form-control" placeholder="Número" name="number" value="<?php echo old('number', $teacher->address->number); ?>" id="number">
